...
cmd({
    ...
    try {
        ...
        const nameER_NAME || "RAHUL-MASTER";
        const info = global.botname || "RAHUL-AI-V3";
        ...
        await conn.sendMessage(from, { 
            ...
            contextInfo: {
    externalAdReply: {
        title: global.botname || "RAHUL-AI-V3",
...
cmd({
    ...
    try {
        ...
        await conn.sendMessage(from, { 
            ...
            contextInfo: {
    externalAdReply: {
        title: global.botname || "RAHUL-MASTER",
...
╰────────────────────`;
        ...
        await conn.sendMessage(from, { 
            image: { 
                url: "https://files.catbox.moe/msn93a.jpg"
            }, 
            caption: madeMenu 
        }, { quoted: mek });
    } catch (e) {
